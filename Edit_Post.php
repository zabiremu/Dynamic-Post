...
<body>
    ...
    <div class="card col-6 mx-auto mt-5">
        <p class="card-header">Post Edit</p>
        <form action="./controller/Edit_Post.php" method="POST">
            <input type="hidden" name="id" value="<?=$id?>">
            <input type="text" value="<?=$fetch['tittle']?>" name="tittle"  class=" my-3 form-control">
            <textarea name="detail" cols="30" rows="10" class=" my-3 form-control">
            <?=$fetch['details']?>
            </textarea>
            <button class=" my-3 btn btn-primary btn-sm" name="update">update</button>
        </form>
    </div>
